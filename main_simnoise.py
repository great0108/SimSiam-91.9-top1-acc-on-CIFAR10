...
from model.criterion import SimNoiseLoss
...
parser.add_argument('--trial', type=str, default='simnoise_v1', help='trial id')
...
parser.add_argument('--noise', default=0.01, type=int, help='noise level')               
...
def main():
    ...
    criterion = SimNoiseLoss(args.loss_version, args.noise)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, _) in enumerate(train_loader):
        ...
        out1 = model(images[0])
        out2 = model(images[1])
        loss = criterion(out1['z1'], out2['z1'])
